        ...
        <CardContent>
          {error ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                className={`rounded-full px-2 py-0.5 text-xs ${active ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300" : "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"}`}
              >
...
// Avoid refetching on click when data was prefetched; still revalidate on mutations
export function shouldRevalidate({ formMethod }: ShouldRevalidateFunctionArgs) {
  // Use prefetched data for normal link clicks (GET navs). Revalidate on mutations.
